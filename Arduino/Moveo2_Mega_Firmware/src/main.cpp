...
void setup() {
  ...
  for( int i = 0; i < NUM_JOINTS; ++i) {
    joints[i].motor.setMaxSpeed(joints[i].pulseRev/4); // Set max speed
    joints[i].motor.setPinsInverted(true,true,false); // Signal está conectado ao pul-, e o accel step envia low to high, por isso inverte
